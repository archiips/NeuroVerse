        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="flex flex-col items-center gap-6">
            ...
            <p className="max-w-3xl text-base font-normal text-gray-200 md:text-lg">
              Explore, visualize, and interact with cutting-edge neuroscience data. NeuroVis provides tools for researchers, educators, and enthusiasts to unlock insights from complex datasets.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-lg leading-8 text-gray-600 dark:text-gray-400">
              NeuroVis offers a suite of powerful tools designed to make neuroscience data accessible and actionable.
            </p>
          </div>
