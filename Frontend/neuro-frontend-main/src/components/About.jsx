...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-[#101922]">
      {/* Header */}
      <header className="border-b border-[#233648] px-4 sm:px-10 py-4">
        <div className="max-w-[960px] mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <h1 className="text-xl font-bold text-white">NeuroVerse</h1>
          </div>
          <div className="flex items-center gap-4 sm:gap-8">
            <button
              onClick={() => navigate('/datasets')}
              className="hidden sm:block text-white text-sm font-medium hover:text-primary-blue transition-colors"
            >
              Dashboard
            </button>
            <button
      ...
      <main className="max-w-[960px] mx-auto px-4 sm:px-10 py-8">
        ...
        <section className="mb-8">
          <h2 className="text-white text-4xl md:text-5xl font-black leading-tight tracking-[-0.033em] mb-4">
            Our Mission
          </h2>
          <p className="text-[#92adc9] text-base md:text-lg font-normal leading-normal max-w-2xl">
        ...
        <section className="mb-8">
          <div className="mb-6">
            <h2 className="text-white text-[32px] font-bold leading-tight mb-2">Key Features</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="flex flex-col gap-4 rounded-xl border border-[#233648] bg-[#192633]/50 p-6 transition-all duration-300 hover:bg-[#233648] hover:scale-105">
              ...
              <div>
                <h3 className="text-white text-lg font-bold leading-tight mb-2">Real Data Visualizations</h3>
            ...
            <div className="flex flex-col gap-4 rounded-xl border border-[#233648] bg-[#192633]/50 p-6 transition-all duration-300 hover:bg-[#233648] hover:scale-105">
              ...
              <div>
                <h3 className="text-white text-lg font-bold leading-tight mb-2">Verified Datasets</h3>
                <p className="text-[#92adc9] text-sm font-normal leading-normal">
            ...
            <div className="flex flex-col gap-4 rounded-xl border border-[#233648] bg-[#192633]/50 p-6 transition-all duration-300 hover:bg-[#233648] hover:scale-105">
              ...
              <div>
                <h3 className="text-white text-lg font-bold leading-tight mb-2">Smart Filtering</h3>
                <p className="text-[#92adc9] text-sm font-normal leading-normal">
        ...
        <section className="mb-8">
          <div className="mb-6">
            <h2 className="text-white text-[32px] font-bold leading-tight mb-2">Technology Stack</h2>
            <p className="text-[#92adc9] text-base font-normal leading-normal max-w-[720px]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={idx} className="flex flex-col gap-4">
                ...
                <div>
                  <p className="text-white text-base font-medium leading-normal mb-1">{tech.name}</p>
                  <p className="text-[#92adc9] text-sm font-normal leading-normal">{tech.desc}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        {/* About Me */}
        <section className="mb-8">
          <h2 className="text-white text-[22px] font-bold leading-tight tracking-[-0.015em] mb-4">About Me</h2>
          <div className="bg-[#192633]/50 rounded-xl p-6 border border-[#233648] transition-all duration-300 hover:bg-[#233648]">
            <h3 className="text-white text-xl font-bold mb-2">Archit Jaiswal</h3>
            <p className="text-primary-blue font-medium mb-3">Creator & Developer</p>
            <p className="text-[#92adc9] leading-relaxed mb-4">
        ...
        {/* Acknowledgments */}
        <section className="mb-8">
          <h2 className="text-white text-[22px] font-bold leading-tight tracking-[-0.015em] mb-4">Acknowledgments</h2>
          <div className="space-y-4">
            <div className="bg-[#192633]/50 rounded-xl p-6 border border-[#233648] transition-all duration-300 hover:bg-[#233648] hover:scale-[1.02]">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-white text-lg font-bold mb-2">OpenNeuro</h3>
                  <p className="text-[#92adc9] text-sm leading-relaxed mb-3">
            ...
            <div className="bg-[#192633]/50 rounded-xl p-6 border border-[#233648] transition-all duration-300 hover:bg-[#233648] hover:scale-[1.02]">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-white text-lg font-bold mb-2">Plotly.js</h3>
            ...
            <div className="bg-[#192633]/50 rounded-xl p-6 border border-[#233648] transition-all duration-300 hover:bg-[#233648] hover:scale-[1.02]">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-white text-lg font-bold mb-2">Neuroscience Community</h3>
                  <p className="text-[#92adc9] text-sm leading-relaxed">
        ...
        {/* Contact Section */}
        <section id="contact">
          <h2 className="text-white text-[22px] font-bold leading-tight tracking-[-0.015em] mb-4">Contact Me</h2>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <input
                  ...
                  required
                  className="w-full rounded-lg border border-[#233648] bg-[#192633]/50 p-3 text-white placeholder-[#92adc9] focus:border-primary-blue focus:ring-1 focus:ring-primary-blue focus:outline-none transition-colors"
              ...
              <textarea
                ...
                required
                rows={6}
                className="w-full rounded-lg border border-[#233648] bg-[#192633]/50 p-3 text-white placeholder-[#92adc9] focus:border-primary-blue focus:ring-1 focus:ring-primary-blue focus:outline-none resize-none transition-colors"
      ...
      {/* Footer */}
      <footer className="border-t border-[#233648] py-6 mt-8">
        <div className="max-w-[960px] mx-auto px-4 sm:px-10">
          <p className="text-center text-[#92adc9] text-sm">
